...
| Unsafe AI-generated changes merged unflagged | Pre-merge safety gate (official VibeGuard hygiene + domain checks) | VibeGuard | [`vibeguard-gate`](https://pypi.org/project/vibeguard-gate/), [`scripts/vibeguard_gate.py`](../scripts/vibeguard_gate.py), [`.github/workflows/vibeguard.yml`](../.github/workflows/vibeguard.yml), [`docs/vibeguard.md`](vibeguard.md) | Implemented |
